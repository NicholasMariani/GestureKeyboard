...
public class Keyboard {
    ...
    public static final int KEYCODE_SEND = -4;
     ...
     * @attr ref android.R.styleable#Keyboard_Key_keyMode
     */
    public static class Key {
        ...
        public Key(Resources res, Keyboard.Row parent, int x, int y, XmlResourceParser parser) {
            ...
            keyMode = a.getInt(R.styleable.Keyboard_Key_keyMode, 0);
            System.out.println("KEY LABEL: " + label + " KEY MODE INIT: " + keyMode);
            a.recycle();
        }
